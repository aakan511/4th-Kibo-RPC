...
public class Target {
    ...
    private static Quaternion[] orientations = new Quaternion[]{ (new Quaternion(0f, 0f, -0.707f, 0.707f)), (new Quaternion(0.5f, 0.5f, -0.5f, 0.5f)), (new Quaternion(0f, 0.707f, 0f, 0.707f)),
            (new Quaternion(0, 0, -1, 0)), (new Quaternion(-0.5f, -0.5f, -0.5f, 0.5f)), (new Quaternion(0, 0, 0, 1)), (new Quaternion(0f, 0.707f, 0f, 0.707f)), new Quaternion(0f, 0f, -0.707f, -0.707f)};
    ...
    private static double[] AverageTime = {41.26, 41.28, 41.64, 40.54, 35.72, 31.24};
    ...
    private static Path[] QR = {new Path(63.6, new Point[]{new Point(11.38, -8.56, 4.85)}, orientations[6]),
            new Path(72.9, new Point[]{new Point(10.7, -8.95, 4.8), new Point(11.38, -8.56, 4.85)}, orientations[6]),
            new Path(59.0, new Point[]{new Point(11.38, -8.56, 4.85)}, orientations[6]),
            new Path(68.4, new Point[]{new Point(11.38, -8.56, 4.85)}, orientations[6]),
            new Path(57.6, new Point[]{new Point(11.38, -8.56, 4.85)}, orientations[6]),
            new Path(52.4, new Point[]{new Point(11.38, -8.56, 4.85)}, orientations[6])};

    private static Path[] goal = {new Path(61.7, new Point[]{new Point(11.2, -8.5, 4.75), new Point(11.143d, -6.7607d, 4.9654d)}, orientations[7]),
            new Path(54.4, new Point[]{new Point(10.8, -8.5, 4.75), new Point(11.143d, -6.7607d, 4.9654d)}, orientations[7]),
            new Path(26.3, new Point[]{new Point(11.143d, -6.7607d, 4.9654d)}, orientations[7]),
            new Path(21.6, new Point[]{new Point(11.143d, -6.7607d, 4.9654d)}, orientations[7]),
            new Path(27.4, new Point[]{new Point(11.143d, -6.7607d, 4.9654d)}, orientations[7]),
            new Path(36.2, new Point[]{new Point(11.143d, -6.7607d, 4.9654d)}, orientations[7]),
            new Path(33.456, new Point[]{new Point(11.143d, -6.7607d, 4.9654d)}, orientations[7])};
...
//            }
    ...
    public static List<Integer> planPath(List<Integer> targets, int currTarget){
        ...
        if(targets.size() == 2){
            ...
            double dist1 = getPath(currTarget, nextTarget).getDistance() + getPath(nextTarget, nextNextTarget).getDistance() + AverageTime[nextNextTarget - 1];
            double dist2 = getPath(currTarget, nextNextTarget).getDistance() + getPath(nextNextTarget, nextTarget).getDistance() + AverageTime[nextTarget - 1];
    ...
    public static Long nextTargetTime(int currTarget, int nextTarget, boolean readQR){
        if(readQR){
            return (long)((getPath(currTarget, 8)).getDistance() * 1000);
        }
        if(currTarget == nextTarget)
            return 0L;
        return (long)((getPath(currTarget, nextTarget)).getDistance() * 1000);
